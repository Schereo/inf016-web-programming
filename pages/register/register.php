...
<section>
    ...
    <form class="register-body" method="post">
        ...
        <input class="input form-control" type="text" name="firstNameReg" placeholder="Vorname" maxlength="20" required>
        <input class="input form-control" type="text" name="lastNameReg" placeholder="Nachname" maxlength="20" required>
        <input class="input form-control" type="email" name="emailReg" placeholder="Email" maxlength="50" required>
        <?php
        ...
        <?php } ?>
        <input class="input form-control"  id="regPassword" type="password" name="passwordReg" placeholder="Passwort" minlength="5" maxlength="20" required>
        ...
        <input class="input form-control" type="password" name="password2Reg" placeholder="Passwort wiederholen" minlength="5" maxlength="20" required>
        <?php
