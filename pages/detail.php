<article class>
    ...
    <p> Berufsbildungszentrum für Wirtschaft, Informatik und Gesundheit<br>
        ...
        Verfügbare Bildungsgänge an dieser Schule (Grobübersicht):
        <ul>
            <li>Berufsschulen »: Wirtschaft, Informatik, Gesundheit</li>
            <li>Berufsfachschulen »: Wirtschaft, Informatik</li>
            <li>Fachoberschulen »: Gesundheit, Informatik</li>
