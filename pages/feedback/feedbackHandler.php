...
if($query->hasRatingsForSchool($_SESSION['user_ID'],$school_id) != null){
    ...
    $update->updateRatings($canteen, $learnEnvironment, $teacher, $activity, $school_id, $_SESSION['user_ID']);
}else{
    $insert = new Insert((new DatabaseConnector())->connect());
    $insert->newRating($canteen, $learnEnvironment, $teacher, $activity, $school_id, $_SESSION['user_ID']);
}
