<section>
    ...
    <form class="login-body" method="post">
        ...
        <input class="input form-control" id="login-e-mail" type="email" name="emailLogin" placeholder="E-Mail Adresse" required>
        <input class="input form-control" id="login-password" type="password" name="passwordLogin" placeholder="Passwort" required>
        <?php
